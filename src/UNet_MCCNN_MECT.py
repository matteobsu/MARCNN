...
#        self.output = net1D
    ...
    def build_1Dnetwork(self, input_data):
        ...
        conv1D_l1d_1 = SeparableConv1D(8, (2,), depth_multiplier=1, activation=self.activ_func, input_shape=shape_conv1D,
                              data_format="channels_last", padding="same", activity_regularizer=self.reg)(conv1D_in_reshape)
        conv1D_l1d_2 = Conv1D(8, self.conv_k_1D, activation=self.activ_func, padding="same", activity_regularizer=self.reg)(conv1D_l1d_1)
        ...
        conv1D_l2d_1 = SeparableConv1D(8, (2,), depth_multiplier=1, activation=self.activ_func, padding="same",
        ...
        conv1D_l3_1 = SeparableConv1D(16, (2,), depth_multiplier=1, activation=self.activ_func, padding="same",
        ...
        conv1D_l2s_1 = SeparableConv1D(8, (2,), depth_multiplier=1, activation=self.activ_func, padding="same",
        ...
        conv1D_l1s_1 = SeparableConv1D(8, (2,), depth_multiplier=1, activation=self.activ_func, padding="same",
                              activity_regularizer=self.reg)(ups1D_l3_5)
        concat1D_l1s_2 = Concatenate(axis=2)([conv1D_l1d_2, conv1D_l1s_1])
        conv1D_l1s_3 = Conv1D(8, self.conv_k_1D, activation=self.activ_func, padding="same", activity_regularizer=self.reg)(concat1D_l1s_2)
        conv1D_l1s_4 = Conv1D(8, self.conv_k_1D, activation=self.activ_func, padding="same", activity_regularizer=self.reg)(conv1D_l1s_3)
        # == Output layer == #
    ...
    def build_2Dnetwork(self, input_data):
        ...
        conv2D_l1d_1 = SeparableConv2D(8, self.conv_k_2D, depth_multiplier=1, activation=self.activ_func, input_shape=shape_conv2D,
                              data_format="channels_last", padding="same", activity_regularizer=self.reg)(conv2D_in_reshape)
        conv2D_l1d_2 = Conv2D(8, self.conv_k_2D, activation=self.activ_func, padding="same", activity_regularizer=self.reg)(conv2D_l1d_1)
        ...
        conv2D_l2d_1 = SeparableConv2D(8, self.conv_k_2D, depth_multiplier=1, activation=self.activ_func, padding="same",
                              activity_regularizer=self.reg)(mxp2D_l1d_4)
        conv2D_l2d_2 = Conv2D(88, self.conv_k_2D, activation=self.activ_func, padding="same", activity_regularizer=self.reg)(conv2D_l2d_1)
        ...
        conv2D_l3d_1 = SeparableConv2D(16, self.conv_k_2D, depth_multiplier=1, activation=self.activ_func, padding="same",
        ...
        conv2D_l5_1 = SeparableConv2D(32, self.conv_k_2D, depth_multiplier=1, activation=self.activ_func, padding="same",
                             activity_regularizer=self.reg)(mxp2D_l3d_4)
        conv2D_l5_2 = Conv2D(32, self.conv_k_2D, activation=self.activ_func, padding="same", activity_regularizer=self.reg)(conv2D_l5_1)
        ...
        conv2D_l3s_1 = SeparableConv2D(16, (2,2), depth_multiplier=1, activation=self.activ_func, padding="same",
        ...
        conv2D_l2s_1 = SeparableConv2D(8, (2,2), depth_multiplier=1, activation=self.activ_func, padding="same",
        ...
        conv2D_l1s_1 = SeparableConv2D(8, (2,2), depth_multiplier=1, activation=self.activ_func, padding="same",
                              activity_regularizer=self.reg)(ups2D_l2s_5)
        concat2D_l1s_2 = Concatenate(axis=3)([conv2D_l1d_2, conv2D_l1s_1])
        conv2D_l1s_3 = Conv2D(8, self.conv_k_2D, activation=self.activ_func, padding="same", activity_regularizer=self.reg)(concat2D_l1s_2)
        conv2D_l1s_4 = Conv2D(8, self.conv_k_2D, activation=self.activ_func, padding="same", activity_regularizer=self.reg)(conv2D_l1s_3)
        # == Output layer == #
